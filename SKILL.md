...
* **Violating citation constraints.** Citing references in any section other than Section 2, or failing to cite ALL 40+ gathered references within Section 2.
...
* **CRITICAL CITATION REQUIREMENT**: This section MUST cite ALL of the 40+ references that will be listed in Section 5 using proper in-text citations (e.g., [1], [2-5]). Other sections (Sections 1, 3, 4, 6) MUST NOT contain any references or citations.
...
- Must list **strictly no less than 40 real references**. All references listed here MUST correspond exactly to the citations used in Section 2.
...
- **AUTHOR NAME FORMATTING**: You MUST ensure author names are complete and accurate. Do not overly abbreviate. You must list the first three authors in full (for English authors: Last name, First initials; for Chinese authors: Full name). If there are more than three authors, add ", et al." or ", 等" after the third author. Do NOT drop or omit the names of the second and third authors.
